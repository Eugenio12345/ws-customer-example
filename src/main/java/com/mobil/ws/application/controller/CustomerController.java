...
public class CustomerController {
	...
	private CustomerService<CustomerRequest> customerService;

	@Autowired
	public CustomerController(CustomerService<CustomerRequest> customerService) {
	...
	public ResponseEntity<Void> saveCustomer(@RequestBody CustomerRequest request) throws SQLException {
